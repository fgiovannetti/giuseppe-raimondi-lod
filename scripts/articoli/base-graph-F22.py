...
# TriG
d.serialize(destination="../../dataset/trig/articoli_base-graph-F22.trig", format='trig')

# N-Quads
d.serialize(destination="../../dataset/nquads/articoli_base-graph-F22.nq", format='nquads')
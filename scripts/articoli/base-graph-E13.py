...
""" Base graph :
Articoli, E13 Attribute Assignment
"""
...
# TriG
d.serialize(destination="../../dataset/trig/articoli_base-graph-E13.trig", format='trig')

# N-Quads
d.serialize(destination="../../dataset/nquads/articoli_base-graph-E13.nq", format='nquads')
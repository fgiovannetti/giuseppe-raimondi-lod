...
# TriG
d.serialize(destination="../../dataset/trig/articoli_base-graph-E35.trig", format='trig')

# N-Quads
d.serialize(destination="../../dataset/nquads/articoli_base-graph-E35.nq", format='nquads')
...
# TriG
d.serialize(destination="../../dataset/trig/articoli_base-graph-E78.trig", format='trig')

# N-Quads
d.serialize(destination="../../dataset/nquads/articoli_base-graph-E78.nq", format='nquads')
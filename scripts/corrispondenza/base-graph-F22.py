...
# TriG
d.serialize(destination="../../dataset/trig/corrispondenza_base-graph-F22.trig", format='trig')

# N-Quads
d.serialize(destination="../../dataset/nquads/corrispondenza_base-graph-F22.nq", format='nquads')
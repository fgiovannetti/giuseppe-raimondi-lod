...
# TriG
d.serialize(destination="../../dataset/trig/quaderni_base-graph-E52.trig", format='trig')

# N-Quads
d.serialize(destination="../../dataset/nquads/quaderni_base-graph-E52.nq", format='nquads')
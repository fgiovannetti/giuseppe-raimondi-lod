...
# TriG
d.serialize(destination="../../dataset/trig/quaderni_base-graph-F28.trig", format='trig')

# N-Quads
d.serialize(destination="../../dataset/nquads/quaderni_base-graph-F28.nq", format='nquads')
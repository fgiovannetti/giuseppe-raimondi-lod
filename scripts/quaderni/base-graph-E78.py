...
# TriG
d.serialize(destination="../../dataset/trig/quaderni_base-graph-E78.trig", format='trig')

# N-Quads
d.serialize(destination="../../dataset/nquads/quaderni_base-graph-E78.nq", format='nquads')
...
# TriG
d.serialize(destination="../../dataset/trig/album_base-graph-E54.trig", format='trig')

# N-Quads
d.serialize(destination="../../dataset/nquads/album_base-graph-E54.nq", format='nquads')
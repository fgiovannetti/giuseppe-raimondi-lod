...
# TriG
d.serialize(destination="../../dataset/trig/album_base-graph-E42.trig", format='trig')

# N-Quads
d.serialize(destination="../../dataset/nquads/album_base-graph-E42.nq", format='nquads')
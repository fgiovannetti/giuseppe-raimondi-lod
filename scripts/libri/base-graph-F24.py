...
with open('../../input/libri.csv', mode='r') as csv_file:
	...
	for row in csv_reader:
		...
		d.add((pub_text, prism.publicationDate, Literal(pubdate[0], datatype=XSD.gYear), graph_base))
...
# TriG
d.serialize(destination="../../dataset/trig/libri_base-graph-F24.trig", format='trig')

# N-Quads
d.serialize(destination="../../dataset/nquads/libri_base-graph-F24.nq", format='nquads')
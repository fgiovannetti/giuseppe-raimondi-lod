...
with open('../../input/quaderni_13-07-21_MCT.csv', mode='r') as csv_file:
...
# TriG
d.serialize(destination="../../dataset/trig/additional-graph-2.trig", format='trig')

# N-Quads
d.serialize(destination="../../dataset/nquads/additional-graph-2.nq", format='nquads')
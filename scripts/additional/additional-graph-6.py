...
d.add((URIRef(base_uri + 'annotation/preface-1925/anno1') , oa.hasTarget , URIRef(base_uri + 'pub-text/preface-1925/page100'), graph_6))
...
d.add((URIRef(base_uri + 'annotation/preface-1925/anno2') , oa.hasTarget , URIRef(base_uri + 'pub-text/preface-1925/page100'), graph_6))

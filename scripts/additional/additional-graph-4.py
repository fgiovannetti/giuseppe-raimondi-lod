...
""" Graph 4 (red):
Representation of author's revision of short story title "Dei colombi su una facciata"
...
d.add((URIRef(base_uri + 'notebook/rdq2' + '/text/2/title/1') , ecrm.P106i_forms_part_of, URIRef(base_uri + 'notebook/rdq2' + '/text'), graph_4))
...
d.add((URIRef(base_uri + 'notebook/rdq2' + '/text/2/title/2') , ecrm.P106i_forms_part_of, URIRef(base_uri + 'notebook/rdq2' + '/text'), graph_4))
...
d.add((URIRef(base_uri + 'notebook/rdq2' + '/text/2/title/3') , ecrm.P106i_forms_part_of, URIRef(base_uri + 'notebook/rdq2' + '/text'), graph_4))
...
d.add((URIRef(base_uri + 'textrev-1') , ecrm.P14_carried_out_by, URIRef(base_uri + 'person/giuseppe-raimondi'), graph_4))
...
d.add((URIRef(base_uri + 'textrev-2') , ecrm.P14_carried_out_by, URIRef(base_uri + 'person/giuseppe-raimondi'), graph_4))
...
d.add((URIRef(base_uri + 'textrev-3') , ecrm.P14_carried_out_by, URIRef(base_uri + 'person/giuseppe-raimondi'), graph_4))
...
pub_tit_comunita_25_54 = BNode()
d.add((URIRef('https://w3id.org/giuseppe-raimondi-lod/pub-text/comunita-1954-25/dei-colombi-in-una-facciata') , ecrm.P102_has_title , pub_tit_comunita_25_54, graph_4))
d.add((pub_tit_comunita_25_54 , RDF.type , ecrm.E35_Title, graph_4))
d.add((pub_tit_comunita_25_54 , RDF.value , Literal('Dei colombi in una facciata'), graph_4))
d.add((pub_tit_comunita_25_54 , prism.publicationDate , Literal('1954-06', datatype=XSD.date), graph_4))
...
pub_tit_mignon_55 = BNode()
d.add((URIRef('https://w3id.org/giuseppe-raimondi-lod/pub-text/mignon-racconti-1955/dei-colombi-in-una-facciata') , ecrm.P102_has_title , pub_tit_mignon_55, graph_4))
d.add((pub_tit_mignon_55 , RDF.type , ecrm.E35_Title, graph_4))
d.add((pub_tit_mignon_55 , RDF.value , Literal('Dei colombi in una facciata'), graph_4))

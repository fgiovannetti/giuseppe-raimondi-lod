...
d.parse("../output/trig/base-graph-E10.trig" , format="trig")
d.parse("../output/trig/base-graph-E13.trig" , format="trig")
d.parse("../output/trig/base-graph-E21.trig" , format="trig")
d.parse("../output/trig/base-graph-E22.trig" , format="trig")
d.parse("../output/trig/base-graph-E30.trig" , format="trig")
d.parse("../output/trig/base-graph-E35.trig" , format="trig")
d.parse("../output/trig/base-graph-E40.trig" , format="trig")
d.parse("../output/trig/base-graph-E42.trig" , format="trig")
d.parse("../output/trig/base-graph-E45.trig" , format="trig")
d.parse("../output/trig/base-graph-E52.trig" , format="trig")
d.parse("../output/trig/base-graph-E53.trig" , format="trig")
d.parse("../output/trig/base-graph-E54.trig" , format="trig")
d.parse("../output/trig/base-graph-E78.trig" , format="trig")
d.parse("../output/trig/base-graph-E89.trig" , format="trig")
d.parse("../output/trig/base-graph-F22.trig" , format="trig")
d.parse("../output/trig/base-graph-F28.trig" , format="trig")
d.parse("../output/trig/base-graph-RIT.trig" , format="trig")
d.parse("../output/trig/additional-graph-1.trig" , format="trig")
d.parse("../output/trig/additional-graph-2.trig" , format="trig")
d.parse("../output/trig/additional-graph-3.trig" , format="trig")
...
# with open('Q1-result.csv', mode='w') as my_file:
...
# # Print results to CSV file
# with open('Q2-result.csv', mode='w') as my_file:
#     my_writer = csv.writer(my_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_ALL)
...
# # Print results to CSV file
# with open('Q3-result.csv', mode='w') as my_file:
#     my_writer = csv.writer(my_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_ALL)
...
# # Print results to CSV file
# with open('Q4-result.csv', mode='w') as my_file:
#     my_writer = csv.writer(my_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_ALL)
...
with open('Q10-result.csv', mode='w') as my_file:
    my_writer = csv.writer(my_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_ALL)

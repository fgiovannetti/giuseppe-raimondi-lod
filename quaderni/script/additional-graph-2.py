...
with open('../input/raimondi_q1_54-70_13-07-21-MCT.csv', mode='r') as csv_file:
	...
	for row in csv_reader:
		...
		d.add((URIRef(base_uri + 'notebook/rdq303/text/1/creation'), URIRef('http://erlangen-crm.org/current/P4_has_time-span'), Literal('1976-05-24', datatype=XSD.date), graph_2))
		d.add((URIRef(base_uri + 'notebook/rdq303/text/2/creation'), URIRef('http://erlangen-crm.org/current/P4_has_time-span'), Literal('1976-07-03', datatype=XSD.date), graph_2))
		...
		# Link a different notebook carrying a text about Villon to the work of art it mentions (archive-museum interchange)

...
# RDF/XML
g.serialize(destination="../output/rdf/quaderni-RIT.rdf", format='xml')

# Turtle
g.serialize(destination="../output/ttl/quaderni-RIT.ttl", format='ttl')

# JSON-LD
g.serialize(destination="../output/jsonld/quaderni-RIT.jsonld", format='json-ld')
...
d.parse("../enrichment/output/trig/additional-graph-4.trig" , format="trig")
...
titoli pubblicati: nb has pub version, pub version has title
# data e editore di pubblicazione
# vd. google keep
"""
